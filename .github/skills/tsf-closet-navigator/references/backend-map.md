...
| `character_chat.py` | キャラチャットの作成 / 姿の差し替え（`CharacterChatSourceRequest`: セッション or Prompt Expander エントリ必須）と発言（`CharacterChatMessageRequest`、上限 `consts/character_chat.MESSAGE_MAX`） |
