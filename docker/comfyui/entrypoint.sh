...
DIFFUSION_NSFW_MODEL_URL="${DIFFUSION_NSFW_MODEL_URL:-https://huggingface.co/Phr00t/Qwen-Image-Edit-Rapid-AIO/resolve/main/v23/Qwen-Rapid-AIO-NSFW-v23.safetensor}"
...
download_if_missing "$DIFFUSION_NSFW_MODEL_URL" "models/diffusion_models/Qwen-Rapid-AIO-NSFW-v23.safetensor"
