export const adventure = {
  ...
  voice: {
    ...
    enableHint:
      "手番の完了時に、攻略対象のセリフを AivisSpeech で自動再生します（本文の「名前「セリフ」」行だけを読みます）。再生中はBGMを小さくします。",
    disabledHint:
  ...
  actionPanel: {
    ...
    openChat: "トーク",
    openChatHint:
      "{{name}}とキャラチャットで雑談します（手番・好感度・所持金・日数は変わらず、会話の内容は次の手番の物語に引き継がれます）",
    openChatFailed: "キャラチャットを開けませんでした",
  },
  talk: {
    you: "あなた",
  },
