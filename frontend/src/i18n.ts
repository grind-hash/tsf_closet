  ...
  ja: {
    translation: {
      menu: {
        ...
        bloomer: "TSF Bloomer",
        bloomerDesc: "日々の会話と選択で小さな変化を絡みながら彼女を育てる",
        endings: "エンディング",
      ...
      bloomer: {
        hub: {
          title: "TSF Bloomer",
          newRun: "新規ランを開始",
          namePlaceholder: "キャラ名",
          originPreset: "新規キャラ",
          originSession: "セッション引き継ぎ",
          start: "始める",
          creating: "作成中…",
          myRuns: "ラン一覧",
          loading: "読み込み中…",
          noRuns: "ランがありません。新規ランを開始してください",
          dayLabel: "Day {{day}}/{{max}}",
          stageLabel: "Stage {{stage}}",
          ended: "終了",
          delete: "削除",
          confirmDelete: "このランを削除しますか？",
        ...
        room: {
          ...
          ended: "エンディング",
          back: "一覧に戻る",
          talkPlaceholder: "話しかける… (Enter で送信)",
          send: "送る",
          sending: "送信中…",
          cancel: "キャンセル",
          waitingNarration: "アクションを選んでください",
          stageUp: "Stage {{stage}} に変化！",
        },
        axes: {
          allure: "魅惑",
          technique: "技巧",
        ...
        actions: {
          ...
          indulge_tease: "焦らす",
          indulge_devote: "深める",
          train_allure: "魅惑トレーニング",
          train_technique: "技巧トレーニング",
          train_depravity: "倒錯トレーニング",
          train_sensitivity: "感度トレーニング",
          train_endurance: "忍耐トレーニング",
          train_composure: "自制トレーニング",
        },
        milestones: {
          defaultTitle: "分岐点",
          chooseOne: "選んだ道は取り戻せない。",
          first_promise: {
            title: "初めての約束",
            choices: {
              shelter: "守ることを選ぶ",
              challenge: "振り切ることを決意する",
              indulge: "身を任せる",
            },
          },
          turning_point: {
        ...
        outfits: {
          plain_dress: "シンプルドレス",
          school_uniform: "制服",
          casual_knit: "カジュアルニット",
          frilled_blouse: "フリルブラウス",
          evening_gown: "イブニングドレス",
          lace_lingerie: "レースランジェリー",
          bloom_regalia: "満開の正装",
        },
      },
      adventure: {
      ...
      settings: {
        ...
        experimentalBloomer: "TSF Bloomer",
        experimentalBloomerDesc:
          "小さな選択と日常を繰り返す、言葉で級亶を育てるモードのメニューを表示します",
  ...
  en: {
    translation: {
      menu: {
        ...
        bloomer: "TSF Bloomer",
        bloomerDesc: "Grow together through daily choices and quiet moments",
        endings: "Endings",
      ...
      bloomer: {
        hub: {
          ...
          originPreset: "New character",
          originSession: "Import from session",
          start: "Start",
          creating: "Creating...",
          myRuns: "My Runs",
          loading: "Loading...",
          noSessions: "No sessions found",
          sessionItems: "entries",
        },
        room: {
          dayLabel: "Day {{day}} / {{max}}",
          stageLabel: "Stage {{stage}}",
          actionsLeft: "{{n}} actions left",
          mood: "Mood",
          stamina: "Stamina",
          trust: "Trust",
          regenImage: "Generate Image",
          ...
          ended: "Ending",
          back: "Back",
          talkPlaceholder: "Say something... (Enter to send)",
          send: "Send",
          sending: "Sending...",
          cancel: "Cancel",
          waitingNarration: "Choose an action",
          stageUp: "Stage {{stage}} reached!",
        },
        axes: {
          allure: "Allure",
          technique: "Technique",
        ...
        actions: {
          ...
          outing: "Outing",
          indulge_tease: "Tease",
          indulge_devote: "Devote",
          train_allure: "Train Allure",
          train_technique: "Train Technique",
          train_depravity: "Train Depravity",
          train_sensitivity: "Train Sensitivity",
          train_endurance: "Train Endurance",
          train_composure: "Train Composure",
        },
        milestones: {
          defaultTitle: "Branching Point",
          chooseOne: "Your choice cannot be undone.",
          first_promise: {
            title: "First Promise",
            choices: {
              shelter: "Choose to shelter",
              challenge: "Decide to push forward",
              indulge: "Indulge",
            },
          },
          turning_point: {
          ...
          final_wish: {
            title: "Final Wish",
            choices: {
              keep: "Stay as you are",
              release_free: "Set free",
        ...
        outfits: {
          plain_dress: "Plain Dress",
          school_uniform: "School Uniform",
          casual_knit: "Casual Knit",
          frilled_blouse: "Frilled Blouse",
          evening_gown: "Evening Gown",
          lace_lingerie: "Lace Lingerie",
          bloom_regalia: "Bloom Regalia",
        },
      },
      adventure: {
        title: "TSF Scenario",
      ...
      settings: {
        ...
        experimentalBloomer: "TSF Bloomer",
        experimentalBloomerDesc: "Show the companion mode — raise her day by day through small choices and conversation",
